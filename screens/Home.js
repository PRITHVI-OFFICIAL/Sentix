...
<Text style={{marginTop:10,fontSize:12,color:"white",textAlign:"center"}}>Reports</Text>
       ...
       <View>
        ...
        <Text style={{marginTop:5,fontWeight:"500",marginLeft:10}}>Digital Management</Text>
        </View>
        </TouchableOpacity> 
        ...
        <Text style={{marginTop:5,fontWeight:"500",marginLeft:10}}>Impact of Sentiment Analysis</Text>
        </View>
        </TouchableOpacity>
        ...
        <Text style={{marginTop:5,fontWeight:"500",marginLeft:10}}>Market of AI</Text>
        </View>
        </TouchableOpacity>
